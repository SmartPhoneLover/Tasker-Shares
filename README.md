...
![badge](https://i.imgur.com/QPDAgFO.png) = Requests that for some reason could not be developed, so got archived. But not forgotten.<br>
<br>
...
--------------
Here you can be updated with the latest modifications on the current progress of the last requests received:<br>
